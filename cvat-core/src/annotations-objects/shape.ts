...
export class Shape extends ScoredMixin(Drawn) {
    ...
    public updateFromServerResponse(body: Partial<SerializedShape> & { id: number }): void {
        this._serverId = body.id;
        this.createdBy = body.created_by ?? this.createdBy;
        this.createdDate = body.created_date ?? this.createdDate;
        this.updatedBy = body.updated_by ?? this.updatedBy;
        this.updatedDate = body.updated_date ?? this.updatedDate;
    }
